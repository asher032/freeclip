...
OpenShorts is a free open source AI clip generator built to clip what people actually watch. It transforms long YouTube videos or local uploads into 9:16 short clips for TikTok, Instagram Reels, and YouTube Shorts. Uses Google Gemini for clip selection — identifying moments with emotional arcs, curiosity loops, and genuine payoffs — and title generation.
...
4. **AI Analysis** - Gemini identifies 3-15 moments with strong watch-through potential (15-60 sec each)
...
| `gemini_worker.py` | Structured Gemini prompts for clip scoring and detailing |
