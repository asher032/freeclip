...
it purely by what you SEE. Watch the whole thing and pick the {min_clips}–{max_clips} best
visual moments for TikTok / Reels / Shorts — the moments a viewer would watch
through (action, reveals, transformations, striking or funny shots, satisfying
payoffs, dramatic movement).
...
Select the best candidate windows — the moments people actually watch through.

Rules:
- Return only valid JSON.
- Choose up to 3 windows from this batch.
- `score` must be an integer from 0 to 100.
- THE 3-SECOND TEST is the main criterion: would the first 3 seconds of this
  moment make a viewer commit to watching the rest? Windows that only work
  with prior context score low.
- Prefer windows with a clear emotional arc (setup → tension → payoff),
  genuine surprise, useful insight, or a story that rewards watching to the end.
...
Choose the BEST short clips from these shortlisted candidate windows — the
moments people actually watch through, share, and come back to.
...
- THE 3-SECOND RULE: the clip MUST open on its strongest moment. If the first
  3 seconds would not earn a viewer's commitment, move the start or skip the clip.
...
- Genuine surprise: "Wait, that actually works?"
- Value promise: "This one trick saved me hours."
...
- `predicted_score`: honest 0-100 estimate of watch-through potential.
