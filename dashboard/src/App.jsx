...
function App() {
  ...
  const [uploadPostKey, setUploadPostKey] = useState(() => {
    ...
    return import.meta.env.VITE_UPLOAD_POST_KEY || '';
  });
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-muted text-base md:text-lg leading-relaxed max-w-2xl">
                    Drop your videos in a folder and a team of AI clippers picks the best moments, edits them, and queues them for your approval — like having a 24/7 short-form editing crew on autopilot.
                  </p>
                </div>
