...
export default function Landing({ onLaunchApp }) {
  ...
  const features = [
    {
      icon: Sparkles,
      title: "AI Clip Selection",
      description: "Gemini analyzes your transcript for moments with emotional arcs, curiosity loops, and genuine payoffs — the clips people actually watch through and share."
    },
    {
      icon: Scissors,
      title: "Smart 9:16 Vertical Cropping",
      description: "Dual-mode AI reframing with MediaPipe face tracking and YOLOv8 fallback. Subjects stay centered, landscapes stay readable."
    },
    {
      icon: Subtitles,
    ...
    },
    {
      ...
      description: "AI-generated text overlays that tease the value of the clip — not clickbait, just genuine curiosity."
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "Upload podcasts, webinars, livestreams, and vlogs at full resolution. Your files never leave your machine."
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "AI thumbnail generator, 10 title suggestions with refinement chat, and auto descriptions with chapters."
    },
    {
      icon: Globe,
  ...
  const steps = [
    ...
    { title: "AI Finds the Moments People Watch", description: "Gemini reads the transcript for emotional arcs, curiosity loops, and payoffs — 3-15 clips of 15-60 seconds." },
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "OpenShorts is a free, open source AI clip generator that transforms your long-form videos — podcasts, webinars, livestreams, vlogs, interviews — into short clips people actually watch, in 9:16 vertical format. It uses a multi-step AI pipeline: faster-whisper for transcription with word-level timestamps, PySceneDetect for scene boundary detection, and Google Gemini for identifying the moments with the strongest emotional arcs, curiosity loops, and payoffs. According to HubSpot's 2025 State of Marketing report, short-form video delivers the highest ROI of any content format, and repurposing long-form content into shorts increases total reach by up to 300%."
    },
    {
      question: "How does OpenShorts compare to Opus Clip?",
      answer: "OpenShorts is a free, self-hosted alternative to Opus Clip. Both offer AI clip selection and smart vertical cropping. Key differences: OpenShorts is completely free vs Opus Clip's $15-228/month pricing. OpenShorts runs on your infrastructure (full data privacy) vs cloud-only. OpenShorts uses Google Gemini for AI analysis vs Opus Clip's proprietary model. OpenShorts adds AI voice dubbing in 30+ languages, AI-generated video effects, and hook text overlays. The trade-off is that OpenShorts requires Docker self-hosting, while Opus Clip is a ready-to-use cloud service."
    },
    {
      question: "How do I turn a long-form video into TikTok or Reels clips?",
      answer: "Upload your long-form video into OpenShorts, enter your free Gemini API key, and click Process. The AI transcribes it with faster-whisper, identifies the best moments using Google Gemini (emotional arcs, curiosity loops, payoffs), and crops them to 9:16 vertical format with MediaPipe face tracking. According to Wyzowl's 2025 Video Marketing Statistics report, 91% of businesses use video as a marketing tool, and repurposed short-form clips drive 2.5x more engagement than original content."
    },
    {
    ...
    },
    {
      ...
      answer: "OpenShorts uses Google Gemini for clip selection and title generation. The AI receives the full video transcript with timestamps, scene boundary data from PySceneDetect, and identifies the 3-15 moments with the strongest emotional arcs, curiosity hooks, and payoffs — the clips people actually watch through and share. Each clip is scored on watch-through potential: would someone commit to watching this to the end? This is different from clickbait detection — it prioritizes genuine engagement over shock value."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink2 overflow-x-clip">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_auto] gap-14 items-center">
          <div className="min-w-0">
            ...
            <p className="hero-description text-muted max-w-2xl mb-8 leading-relaxed lowercase">
              turn long videos into 9:16 shorts people actually watch, or generate ugc marketing videos with ai actors. online, in the cloud, zero setup.
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="card p-8">
              ...
              <p className="text-muted text-sm leading-relaxed mb-4">Open source AI clipping tool: turn long-form videos into 9:16 shorts people actually watch.</p>
              <ul className="space-y-1.5">
                {['AI clip selection (watch-through optimized)', 'Smart face-tracking crop', 'Auto subtitles + AI dubbing in 30+ languages'].map((f, i) => (
      ...
      <section id="features" className="py-20 px-6 border-t border-rule">
        <div className="max-w-6xl mx-auto">
          <SectionHeader eyebrow="05 · Features" title="Free AI Clip Generator + UGC Video Creator">
            Built to clip what people actually watch. A smart AI video clipper for TikTok, Reels & Shorts.
          </SectionHeader>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <div className="card p-6 relative">
              ...
              <p className="text-muted text-sm leading-relaxed">Powers all AI features: clip selection, title generation, video effects, YouTube thumbnail creation, and description writing. The core engine of OpenShorts.</p>
            </div>
            <div className="card p-6 relative">
      ...
      <section id="how-it-works" className="py-20 px-6 border-t border-rule">
        <div className="max-w-4xl mx-auto">
          <SectionHeader eyebrow="07 · Pipeline" title="How It Works">
            From long-form video to shareable clips in 5 automated steps.
          </SectionHeader>
      ...
      <section id="comparison" className="py-20 px-6 border-t border-rule">
        <div className="max-w-4xl mx-auto">
          <SectionHeader eyebrow="09 · Comparison" title="Free AI Clip Generator vs Paid Alternatives">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                ...
                <ComparisonRow feature="AI Clip Selection (watch-through)" openshorts={checkIcon} opusclip={checkMuted} kapwing={checkMuted} />
            ...
            {[
              {
                ...
                description: "Extract the moments people actually watch from your long-form videos into TikTok and Reels clips.",
                icon: Youtube
              },
              {
              ...
              },
              {
                ...
                description: "Find the moments that keep listeners engaged — the insights, stories, and reactions worth clipping.",
                icon: FileVideo
              },
              {
      ...
      <section className="py-24 px-6 border-t border-rule">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-4xl md:text-5xl lowercase text-ink tracking-tight mb-5">start clipping what people actually watch.</h2>
      ...
      <footer className="border-t border-rule py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <p className="font-display text-3xl md:text-5xl lowercase text-ink tracking-tight mb-10">clip what people actually watch.</p>
          <nav aria-label="Guides and comparisons" className="border-t border-rule pt-6 mb-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm lowercase text-muted">
            ...
            <a href="/clips-people-actually-watch" className="hover:text-ink transition-colors">clips people watch</a>
          ...
          <div className="border-t border-rule pt-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted">OpenShorts — Free Open Source AI Clip Generator</span>
            </div>
