...
export const PIPELINE_STEPS = [
  ...
  {
    title: 'Clip selection (watch-through optimized)',
    body: 'Google Gemini receives the timestamped transcript and the scene boundaries together, and returns the 3 to 15 strongest segments of 15 to 60 seconds. Each one is scored on emotional arc, curiosity hook, and how well it stands alone without the surrounding context — the moments people actually watch through and share.',
  },
  {
...
export const COMPARISON_ROWS = [
  ...
  { feature: 'AI clip selection (watch-through)', os: 'Yes, Gemini', vendor: 'Yes' },
