...
const FEATURES = [
  ['AI clip selection', 'Google Gemini scores the transcript and scene data to find the 3 to 15 strongest moments — the ones people actually watch through — so there is no manual scrubbing.'],
