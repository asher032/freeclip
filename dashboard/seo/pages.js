...
`
  ...
  return {
    ...
    tldr: [
      ...
      `Both find the best moments in long video and reframe them to 9:16 with face tracking. OpenShorts adds dubbing into 30+ languages and AI UGC video with lip-synced actors. ${esc(c.name)} has the more polished caption library.`,
...
${faqBlock([
  {
    q: 'What AI model does OpenShorts use to find the best moments?',
    a: 'Google Gemini. It receives the word-level transcript with timestamps together with PySceneDetect scene boundaries, and returns 3 to 15 segments of 15 to 60 seconds scored on emotional arc, curiosity hook, and whether the segment stands alone without surrounding context — the moments people actually watch through and share.',
  },
  {
...
`,
  faq: [
    {
      q: 'What AI model does OpenShorts use to find the best moments?',
      a: 'Google Gemini, which receives the word-level transcript with timestamps together with PySceneDetect scene boundaries and returns 3 to 15 segments of 15 to 60 seconds.',
    },
    {
      q: 'How does the automatic vertical cropping work?',
