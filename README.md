...
**Free open source AI clip generator** — built to clip what people actually watch. 3 tools in one: **Clip Generator**, **AI Shorts (UGC videos with AI actors)**, and **YouTube Studio**.
...
### 1. Clip Generator
Turn your long-form videos — podcasts, webinars, livestreams, vlogs, interviews — into 9:16 shorts people actually watch, for TikTok, Instagram Reels, and YouTube Shorts.
...
### Clip Generator
- **AI Clip Selection**: Google Gemini analyzes transcripts for emotional arcs, curiosity loops, and genuine payoffs — the moments people actually watch through and share
...
- **Hook Text Overlays**: AI-generated text overlays that tease the value of the clip
...
|---------|-----------|-----------|----------|
| **Google Gemini** | Free trial with generous limits | < $0.01 per 10-min video | Clip selection, script generation, web research |
...
4. **Analyze** — Gemini identifies 3-15 moments with strong watch-through potential (15-60s each)
